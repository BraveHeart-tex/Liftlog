...
import { useActiveWorkoutExerciseDraft } from '@/src/features/workouts/active/hooks/use-active-workout-exercise-draft';
import { useActiveWorkoutScreen } from '@/src/features/workouts/active/hooks/use-active-workout-screen';
...
export function ActiveWorkoutEditExercisesScreen() {
