...
import { useHistoricalWorkoutDraftActions } from '@/src/features/workouts/history/hooks/use-historical-workout-draft-actions';
import { useHistoricalWorkoutDraftScreen } from '@/src/features/workouts/history/hooks/use-historical-workout-draft-screen';
import { router } from 'expo-router';
import { ArrowLeftIcon } from 'lucide-react-native';
import { useCallback } from 'react';

export function HistoricalWorkoutDraftScreen({
  workoutId
}: {
  workoutId?: string;
}) {
