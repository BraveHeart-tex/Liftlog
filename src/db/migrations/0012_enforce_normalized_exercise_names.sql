...
INSERT INTO `__new_exercises`("id", "name", "normalized_name", "category", "tracking_type", "primary_muscles", "secondary_muscles", "is_custom", "is_archived", "created_at") SELECT "id", "name", "normalized_name", "category", "tracking_type", "primary_muscles", "secondary_muscles", "is_custom", "is_archived", "created_at" FROM `exercises`;--> statement-breakpoint
